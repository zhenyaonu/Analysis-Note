...
Let $\Omega \subset \mathbb{C}$ be an open set and let $f: \mathbb{C} \ni \Omega \to \mathbb{C}$ be function, and $f$ can be regarded as a "real" function $f: \mathbb{R}^2 \supset \Omega \to \mathbb{R}^2$. Now recall that $f$ is differentiable in the real sense of $z_0 \in \Omega$ if there is a linear map $L: \mathbb{R}^2 \to \mathbb{R}^2$ such that
\begin{align*}
...
On the other hand, if $f: \mathbb{R}^2 \supset \Omega \to \mathbb{R}^2$ is real differentiable and there is $z_1 \in \mathbb{C}$ such that $Df(z_0) z = z_1 z$, then $f: \mathbb{C} \ni \Omega \to \mathbb{C}$ is complex differentiable in the complex sense and $f'(z_0) = z_1$. 

Now we proved that $f: \mathbb{C} \ni \Omega \to \mathbb{C}$ is complex differentiable if and only if it is real differentiable as a mapping $f: \mathbb{R}^2 \supset \Omega \to \mathbb{R}^2$ and there is $z_1 \in \mathbb{C}$ such that $Df(z_0) z = z_1 z$. Then $Df'(z_0) = z_1$.
...
Also, we proved that $f: \mathbb{C} \ni \Omega \to \mathbb{C}$ is complex differentiable if and only if $f$ is real differentiable as $f: \mathbb{R}^2 \supset \Omega \to \mathbb{R}^2$ and the real derivative of $f = u + iv$
\begin{align*}
...
\begin{theorem}
A function $f = u + iv: \mathbb{C} \ni \Omega \to \mathbb{C}$ is complex differentiable at $z_0$ if and only if it is real differentiable at $z_0$ and the Cauchy-Riemann equations
\begin{align*}
    u_x(z_0) = v_y(z_0), \quad u_y(z_0) = - v_x(z_0)
\end{align*}

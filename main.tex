...
\begin{enumerate}[label=(\alph*)]
    \item If $z_0 \neq \infty, f(z_0) \neq \infty$, then $f$ is holomorphic at $z_0$ if and only if $f$ is complex differentiable at $z_0$.
    ...
    \begin{align*}
        ...
        \end{cases}
    \end{align*}
    Hence, $f$ is holomorphic at $z_0 = \infty$ if and only if $g$ is complex differentiable at $z = 0$.
    ...
    \begin{align*}
        ...
        \end{cases}
    \end{align*}
    is complex differentiable at $z_0$. Here we take $\phi = I$, since we need $z_0 \in \phi(\mathbb{C})$, and hence $\phi^{-1}(z_0) = z_0$. Also, we take $\psi = P$, since we need $\infty = f(z_0) \in \psi(\mathbb{C})$.

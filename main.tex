...
\begin{definition}
We say that $f:[a,b] \to \mathbb{R}$ is absolutely continuous if for every $\varepsilon > 0$, there exists $\delta > 0$ such that if $(x_1,x_1+h_1), \cdots, (x_k,x_k+h_k) \subset [a,b]$ are pairwise and $\sum^k_{i=1} h_i < \delta$, then 
\begin{align*}

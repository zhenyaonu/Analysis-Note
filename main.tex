...
\end{corollary}
\begin{proof}\footnote{It is based on the proof of  $\mathbb{R}^n\times\{0\}$ has measure zero in $\mathbb{R}^{n+1}$\cite{16}.} 
...
\end{exercise}
\begin{proof}\footnote{This proof is by Austin Mohr\cite{22}.}
